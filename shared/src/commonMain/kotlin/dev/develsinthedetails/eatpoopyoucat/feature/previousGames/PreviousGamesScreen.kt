...
import eatpoopyoucat.shared.generated.resources.ic_delete_forever_rounded
import eatpoopyoucat.shared.generated.resources.no_games_to_save
import eatpoopyoucat.shared.generated.resources.no_previous_games_found
...
fun PreviousGamesScreen(
    ...
    Scaffolds.PreviousGames(
        title = pluralStringResource(
            Res.plurals.previous_games, games?.count() ?: 0
        ),
            ...
            if (games.isEmpty()) {
                Row(
                    ...
                    Text(
                        ...
                        text = stringResource(Res.string.no_previous_games_found),
                    )
                }
                return@Surface
            }
...
fun GameListItem(game: GameWithEntries, onGotoGame: () -> Unit, onDelete: () -> Unit) {
    ...
    Box(
        ...
        IconButton(
            modifier = Modifier
                .align(Alignment.BottomEnd) // Replaces constraint logic
                .background(
            ...
            Icon(
                ...
                modifier = Modifier,
                contentDescription = stringResource(Res.string.delete_game),
            )
        }

        if (showDeleteConfirmation) {
            ConfirmDialog(
                action = stringResource(Res.string.delete_game),
...
fun ListItem(
    ...
    Card(
        ...
        Column(
            ...
            Text(
                text = stringResource(Res.string.turns, turns),
                textAlign = TextAlign.Center,
                maxLines = 1,
                modifier = Modifier
                    .fillMaxWidth()
