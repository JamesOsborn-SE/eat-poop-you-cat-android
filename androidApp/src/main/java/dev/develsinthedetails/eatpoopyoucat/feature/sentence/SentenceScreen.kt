...
fun SentenceScreen(
    ...
    { innerPadding ->
        Surface(
            ...
            val errorDetails = stringResource(id = R.string.sentence_is_blank)
            BoxWithConstraints(contentAlignment = Alignment.Center) {
                Column(
                    ...
                    if (uiState.previousEntry == null)
                        Column(
                            ...
                            TextButton(
                                ...
                                Text(stringResource(R.string.halp))
                            }
                            AnimatedVisibility(showTips) {
                                Text(stringResource(R.string.sentence_tip))
                            }
                        }
                    Row(
                        modifier = Modifier
                    ...
                    SentenceInput(
                        ...
                        onSubmit,
                        focusRequester,
                        if (uiState.previousEntry == null) stringResource(R.string.write_a_funny_sentence) else stringResource(
                            R.string.write_a_sentence_to_describe_this_drawing
                        ),
                        modifier
                    )
...
fun SentenceScreenPreview() {
    val uiState = SentenceUiState(
        ...
        previousEntry = null,
        isLoading = false,
        sentence = stringResource(id = R.string.oof),
        gameMode = GameMode.LOCAL,
        nickname = null,
        nicknameError = null,
        nicknameIsSatisfied = true,
